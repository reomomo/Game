...
const S = 2; // スプレーした回数
let T = 5; // スプレーした距離
let x = 3; // スプレーした中心が左から何区画目か
let y = 3; // スプレーした中心が上から何区画目か

const aryArea = [...Array(H * W)].fill(0);

// コンソールを見やすくする為の数字登録
aryArea.splice(5, 1, 5);
aryArea.splice(11, 1, 6);
aryArea.splice(17, 1, 7);
aryArea.splice(23, 1, 8);
aryArea.splice(29, 1, 9);
